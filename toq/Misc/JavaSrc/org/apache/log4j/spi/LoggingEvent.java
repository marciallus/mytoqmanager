    ...
    implements Serializable
{
    ...
    public LoggingEvent(String s, Category category, long l, Level level1, Object obj, String s1, 
    ...
    public LoggingEvent(String s, Category category, long l, Priority priority, Object obj, Throwable throwable)
    {
        ndcLookupRequired = true;
        mdcCopyLookupRequired = true;
        fqnOfCategoryClass = s;
        ...
        throws IOException, ClassNotFoundException
    {
        ...
        level = (Level)method.invoke(null, ainteger);
        return;
        level = Level.toLevel(i);
        return;
    }
