...
class OBEXClientOperationGet extends OBEXClientOperation
{
    ...
    OBEXClientOperationGet(OBEXClientSessionImpl obexclientsessionimpl, OBEXHeaderSetImpl obexheadersetimpl)
        throws IOException
    {
        super(obexclientsessionimpl, '\003', obexheadersetimpl);
    }
