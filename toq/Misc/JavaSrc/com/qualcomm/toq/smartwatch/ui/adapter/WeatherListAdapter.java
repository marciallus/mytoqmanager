...
public class WeatherListAdapter extends BaseAdapter
{
    public static interface AdapterInterface
    {
        ...
        public abstract void deleteCity(int i);
    ...
    private class ViewHolder
    {
        ...
        View emptyView;
        LinearLayout layout;
        final WeatherListAdapter this$0;
        TextView tvName1;
        TextView tvName2;
        ImageView view;
        ...
        private ViewHolder()
        {
            this$0 = WeatherListAdapter.this;
            super();
        }
    ...
    public WeatherListAdapter(Context context, AdapterInterface adapterinterface)
    {
        activityRef = null;
    ...
    public View getView(final int city_position, View view, ViewGroup viewgroup)
    {
        ...
        isDeleteVisible = false;
        String as[] = ((String)ambientList.get(city_position)).split(",");
        Log.d("AmbientListAdapter", (new StringBuilder()).append("Name of the entries:   ").append(as[0]).append(as[1]).append(": ").append(as[2]).toString());
        if (as.length >= 1 && as[0] != null)
            holder.tvName1.setText(as[0]);
        if (as.length == 2 && as[1] != null)
            holder.tvName2.setText(as[1]);
        else
        if (as.length == 3 && as[1] != null && as[2] != null)
            holder.tvName2.setText((new StringBuilder()).append(as[1]).append(",").append(as[2]).toString());
        ...
        holder.delete.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            final WeatherListAdapter this$0;
            final int val$city_position;

            public void onClick(View view1)
            {
                Log.i("AmbientListAdapter", " DELETE BUTTON clicked");
                Log.i("AmbientListAdapter", (new StringBuilder()).append("----- city position is ").append(city_position).toString());
                isDeleteVisible = false;
                activityRef.deleteCity(city_position);
            }
