...
class NotificationCompatIceCreamSandwich
{
            ...
            PendingIntent pendingintent1, Bitmap bitmap, int j, int k, boolean flag)
    {
        ...
        if ((2 & notification.flags) != 0)
            ...
            flag1 = false;
        android.app.Notification.Builder builder1 = builder.setOngoing(flag1);
        boolean flag2;
        if ((8 & notification.flags) != 0)
            flag2 = true;
        else
            flag2 = false;
        android.app.Notification.Builder builder2 = builder1.setOnlyAlertOnce(flag2);
        boolean flag3;
        if ((0x10 & notification.flags) != 0)
            flag3 = true;
        else
            flag3 = false;
        android.app.Notification.Builder builder3 = builder2.setAutoCancel(flag3).setDefaults(notification.defaults).setContentTitle(charsequence).setContentText(charsequence1).setContentInfo(charsequence2).setContentIntent(pendingintent).setDeleteIntent(notification.deleteIntent);
        boolean flag4;
